...
export const LOG_COLLECTION = 'https://callinsights-nimbus-service-qa.voice.plivodev.com/collect/logs/';
export const LOG_COLLECTION_JWT = 'https://callinsights-nimbus-service-qa.voice.plivodev.com/collect/logs/jwt/';
